...
export const USER_JOURNEY_THRESHOLDS: IUserJourneyThresholds = {
  ...
  const userJourneySteps: IUserJourneyStepsConfig = {
    ...
    load_third_screen_first_journey: {
      ...
      marks: ['start_navigate_to_third_screen_first_journey', 'loaded_third_screen_first_journey'],
    },
    load_fourth_screen_first_journey: {
      threshold: IThresholdTier.quick,
      marks: ['start_navigate_to_fourth_screen_first_journey', 'loaded_fourth_screen_first_journey'],
    },
    load_first_screen_second_journey: {
      threshold: IThresholdTier.unavoidable,
    ...
    load_second_screen_second_journey: {
      threshold: IThresholdTier.instant,
      marks: ['start_navigate_to_second_screen_second_journey', 'loaded_second_screen_second_journey'],
    },
    load_third_screen_second_journey: {
      threshold: IThresholdTier.quick,
      marks: ['start_navigate_to_third_screen_second_journey', 'loaded_third_screen_second_journey'],
    },
    load_fourth_screen_second_journey: {
      threshold: IThresholdTier.quick,
      marks: ['start_navigate_to_fourth_screen_second_journey', 'loaded_fourth_screen_second_journey'],
    },
  };
